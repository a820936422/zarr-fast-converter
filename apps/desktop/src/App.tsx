...
import { TaskDiagnosticsCard } from "./components/TaskDiagnosticsCard";
    ...
    <div className="app-shell">
      ...
      <main className="main-shell">
        ...
        <div className="page-content">
          {view === "overview" && <OverviewView setView={setView} supportedCount={supportedCount} capabilityItems={capabilityItems} runningTasks={runningTasks} recentPaths={recentPaths} setInputPath={setInputPath} />}
            ...
            <>
              ...
              <div className="pipeline-layout">
                <section className="surface pipeline-surface">
                  ...
                  {!effectiveResample && !rechunk && !recompress && <p className="variable-settings-help">以上处理都未启用：本任务将只执行格式转换并直接发布结果（快速转换模式）。</p>}
