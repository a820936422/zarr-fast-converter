...
use fast_nc_zarr_zarr::{
    ...
    resample_f32_values_into_with_options, resample_f32_values_with_options,
...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
fn resample_f32_buffer_options(
    py: Python<'_>,
    values: &Bound<'_, PyAny>,
    shape: Vec<usize>,
    source_lat: &Bound<'_, PyAny>,
...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
fn resample_f32_buffer_into_options(
    py: Python<'_>,
    values: &Bound<'_, PyAny>,
    shape: Vec<usize>,
    source_lat: &Bound<'_, PyAny>,
...
fn _native(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_function(wrap_pyfunction!(resample_f32_buffer_options, module)?)?;
    module.add_function(wrap_pyfunction!(resample_f32_buffer_into, module)?)?;
    module.add_function(wrap_pyfunction!(resample_f32_buffer_into_options, module)?)?;
