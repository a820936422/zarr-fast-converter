...
- **v1.7.7 修改已提交并推送**：当前 `develop` 分支已包含 v1.7.7 全部修改，并已打 tag `v1.7.7`。
...
| 1.7.7 | 2026-08-18 | 版本提升至 1.7.7；P0、P1、P2 已完成；M6 发布门禁与发布准备完成（deb 候选包已收集）；修改已提交并推送（tag `v1.7.7`）；当前处于开发阶段，暂不打包安装包、暂不上传发布资产，详见 `docs/v1.7.7-optimization-plan.md`、`docs/p2-evaluation.md` |
