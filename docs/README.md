...
本文档目录按可执行模块组织，描述 v1.6.7 的现有功能、使用方式和边界。项目总览、环境安装和快速示例见根目录 [README](../README.md)。
...
| [图形界面](gui.md) | 以数据检查、处理流程和任务中心组织上述能力 | `pixi run gui` |
...
- GUI 内置 Noto Sans SC 字体，不依赖宿主环境的中文字体。
