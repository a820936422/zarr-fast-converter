# Fast NC Zarr v1.8.4 模块与运行指南

本文档合并项目各模块的入口、核心约束和验证方式。项目总览、环境安装和快速示例见根目录 [README](../README.md)。IPC 定义见 [contracts/README.md](../contracts/README.md)。项目维护文档见：[维护文档](MAINTENANCE.md)。后续版本待办见：[v1.8.4 开发文档](v1.8.4-development.md)。历史版本专项文档已整合清理，不再单独维护。
...
v1.8.4 以 Linux `x86_64-unknown-linux-gnu` 为阻塞发布平台。发布前至少执行：
